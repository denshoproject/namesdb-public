...
FIELD_DEFINITIONS['farrecord']['departure_destination']         = {'label': 'Departure City/Town',       'description': 'Destination after departure; city/town only'}
FIELD_DEFINITIONS['farrecord']['departure_state']               = {'label': 'Departure State',           'description': 'Destination after departure; state only'}
...
FIELD_DEFINITIONS['wrarecord']['maritalstatus']                 = {'label': 'Marital status',            'description': 'Marital status'}
